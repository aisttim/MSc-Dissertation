...
poi_data <- readr::read_csv("data/POI_LSOA_Density.csv")
...
angular_segment_gl <- readr::read_csv("data/ANGULAR_segment_GL.csv")
...
segments <- st_read("data/ANGULAR_measures_LINES_geometry/ANGULAR_measures_LINES_geometry.shp")
...
raw_dir <- "data/census data/population and IMD data/"
...
land_data_raw <- readr::read_csv("data/LandUse_LSOA_gl.csv")
...
landscan <- terra::rast("data/landscan-global-2023.tif")
...
files <- list(
  TOV = "data/OF_LSOA_greater_london_22_24.csv",
  TFV = "data/FROM_LSOA_greater_london_22_24.csv",
  ...
  res_pop_dens       = "data/resident_pop_density_RAW.csv",
  work_pop_dens      = "data/workday_pop_density_RAW.csv",
  POI                = "data/POI_LSOA_Density.csv"  # "saved data/POI_LSOA_Density.csv" if used code above to aggregate to LSOAs from point data
)  
